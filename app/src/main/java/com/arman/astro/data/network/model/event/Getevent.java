...
public class Getevent implements IResponse {
    ...
    @Expose
    private List<Object> contentImage = null;
    ...
    public List<Object> getContentImage() {
        return contentImage;
    }

    public void setContentImage(List<Object> contentImage) {
    ...
    public void setVernacularData(List<VernacularDatum> vernacularData) {
